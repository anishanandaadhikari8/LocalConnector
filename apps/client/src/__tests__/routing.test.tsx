...
describe('Routing smoke tests', () => {
  it('renders Admin layout for admin roles', () => {
    useAuthStore.setState({
      token: 't',
      user: { id: 'u1', email: 'a@b.c', display_name: 'Admin' },
      role: 'ADMIN',
      circle: { id: 'c1', name: 'Test Circle', type: 'APARTMENT' },
    });
  ...
  it('does not render Admin layout header for resident role (redirects)', () => {
    useAuthStore.setState({
      token: 't',
      user: { id: 'u2', email: 'r@b.c', display_name: 'Resident' },
      role: 'RESIDENT',
      circle: { id: 'c1', name: 'Test Circle', type: 'APARTMENT' },
    });
    useCircleStore.setState({
  ...
  it('renders Resident layout and tabs for resident', () => {
    useAuthStore.setState({
      token: 't',
      user: { id: 'u3', email: 'r@b.c', display_name: 'Resident' },
      role: 'RESIDENT',
      circle: { id: 'c1', name: 'Test Circle', type: 'APARTMENT' },
    });
    useCircleStore.setState({
